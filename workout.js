      ...
      // content for most of the time. Its however does change
      // from time to time.
     ...
     let time = 1000
      ...
      function general(currentItem, formerItem, time) {
        ...
        return new Promise((resolve, reject) => {
          ...
          ID = window.setInterval(() => {
            ...
            // if sec = 35 and complete = 'yes', resolve the promise
            if (sec > 35) {
      ...
      pauser.addEventListener("click", () => {
        ...
        let { runFunc } = controls;
        if (controls.runFunc === true) {
          reality();
